...
export class Landscape extends THREE.Object3D {
  ...
  styleMeshes(object) {
    ...
    //let planeMaterial = new THREE.MeshBasicMaterial({ color: '#ffffff', wireframe:true, side:THREE.DoubleSide })
    let cylinderMaterial = new THREE.MeshBasicMaterial({ color: '#333333', wireframe:true, side:THREE.DoubleSide })
